...
public class ItemSpectralSword extends ItemSword {
	...
	public void onUpdate(ItemStack itemstack, World par2World, Entity entity, int par4, boolean par5) {
		...
		if(entity instanceof EntityPlayer){
			...
			properties.conjuredSwordDuration++;
			if(properties.conjuredSwordDuration > this.getMaxDamage(itemstack)){
				((EntityPlayer)entity).inventory.consumeInventoryItem(itemstack.getItem());
				properties.conjuredSwordDuration = 0;
			}
		}
	}
