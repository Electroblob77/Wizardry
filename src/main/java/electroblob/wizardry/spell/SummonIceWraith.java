...
public class SummonIceWraith extends Spell {
	...
	public SummonIceWraith() {
		super(EnumTier.ADVANCED, 40, EnumElement.ICE, "summon_ice_wraith", EnumSpellType.MINION, 200, EnumAction.bow, false);
	}
	...
	public boolean cast(World world, EntityPlayer caster, int ticksInUse, float damageMultiplier, float rangeMultiplier, float durationMultiplier, float blastMultiplier) {
		...
		if(!world.isRemote){
			...
			EntityIceWraith iceWraith = new EntityIceWraith(world, x, y, z, caster, (int)(600*durationMultiplier));
			if(Wizardry.showSummonedCreatureNames) iceWraith.setCustomNameTag(StatCollector.translateToLocalFormatted("entity.wizardry.summonedcreature.nameplate", caster.getCommandSenderName(), iceWraith.getCommandSenderName()));
			world.spawnEntityInWorld(iceWraith);
		}
